...
const Button = (props) => {
    ...
    if(props.handleDelete){
        newProps.onClick = props.handleDelete;
    }
    if(props.handleEdit){
        newProps.onClick = props.handleEdit;
    }

    if(props.unsetModal){
        newProps.onClick = props.unsetModal;
    }

    if(props.handleNewsToShow){
        newProps.onClick = props.handleNewsToShow;
    }
